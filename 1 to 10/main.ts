...
let famousQuote: string = "Genius is one percent inspiration and ninety-nine percent perspiration.";
...
let favoritedResult:number = 10;
let messageResult:string =`My favorite Number: ${favoritedResult}`;
